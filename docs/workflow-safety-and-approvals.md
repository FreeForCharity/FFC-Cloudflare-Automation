...
| 226     | WHMCS - Application Triage (rank + accept)   | Writes (report default)   | ✅ whmcs-prod                                                | report=read-only ranking; approve accepts ONLY listed $0 orderids (no accept-all/top-N)       |
