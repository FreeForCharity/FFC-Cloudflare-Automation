...
async function main() {
  ...
  console.log(`Sources detected -> WHMCS: ${hasWhmcs}, Cloudflare: ${hasCf}, WPMUDEV: ${hasWpmudev}`)
  ...
  console.log(`Writing ${mergedData.length} records to ${OUTPUT_CSV_PATH} and ${OUTPUT_JSON_PATH}...`)
