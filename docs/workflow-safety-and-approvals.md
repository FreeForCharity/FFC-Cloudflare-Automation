...
| 702     | Domain - Deploy Static Clone (FFC-EX)              | Writes (gated)            | ✅ github-prod                                               | ungated preflight (repo must exist; refuses live sites unless `force=true`); opens a draft PR (never pushes); serialized                                                                 |
