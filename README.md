...
- **Automated Security Scanning**: tfsec, Checkov, and Trivy analysis for Terraform configurations
...
- **Security Scanning**: tfsec, Checkov, and Trivy analysis for Terraform
