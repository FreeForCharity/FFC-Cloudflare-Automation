...
| 736     | Repo - Archive / Application Denied                | Writes (dry-run default)  | ✅ github-prod                                               | archive-only (reversible, never deletes); `dry_run` default true; typed `confirm_repo`; org-locked + denylist                                                                            |
