# Gemini Instructions: FFC-Cloudflare-Automation

Hey Gemini! Welcome to FFC-Cloudflare-Automation.
...
The site deploys to `https://freeforcharity.github.io/FFC-Cloudflare-Automation/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
